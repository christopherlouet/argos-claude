...
### Added
- Monthly token usage row in dropdown menu
- Yesterday fallback: display yesterday's tokens when today's data is not yet available

### Changed
- Translate entire menu to English (USAGE, SAVINGS, Today/Yesterday, This week, This month, All time, Refresh, View usage on claude.ai)
